    ...
    resources: {
      ...
      es: {
        ...
        home: {
          ...
          settings: 'Ajustes',
          likeTheApp: 'Te gusta el app? Considera calificarlo en la tienda.',
          playStore: 'Play Store'
        },
        list: {
          hold: 'Mantener',
        ...
        skills: {
          ...
          heelFlickTurn: 'Toque de tacón y giro',
          heelChopL: 'Toque de tacón izquierda (en carrera)',
          ...
          threeTouchL: 'Ruleta de tres toques a la izquierda',
          flickUpForVolley5: 'Toque arriba volea',
          reverseStepoverL: 'Bicicleta inversa izquierda',
          openUpL: 'Amagar tiro a la derecha',
          stepoverL: 'Bicicleta izquierda',
          ballRollFakeR: 'Amago de envío derecha (en estático)',
          dragBackSpinR: 'Arrastrar atrás y giro a la derecha',
          fakePassExitR: 'Amagar pase y salir por la derecha (estático)',
          elastico: 'Elástica',
          ...
          fakePass: 'Amagar pase (estático)',
          sombreroFlick: 'Toque de sombrero (estático)',
          spinFlickR: 'Giro y toque a la derecha',
          spinFlickL: 'Giro y toque a la izquierda',
          ...
          dragBackSpinL: 'Arrastrar atrás y giro a la izquierda',
          fakePassExitL: 'Amagar pase y salir por la izquierda (estático)',
          ballRollFakeL: 'Amago de envío izquierda (en estático)',
          ballHop: 'Salto con balón (estático)',
          tornadoSpinL: 'Tornado a la izquierda',
          ...
          laneChangeL: 'Trasladarse a la izquierda',
          ...
          FlickUpVolley: 'Elevarte el balón',
          rouletteR: 'Ruleta derecha',
          tornadoSpinR: 'Tornado a la derecha'
        },
        celebrations: {
          basicMoves: 'Info',
